	...
	$(document).ready(function() {
		$('.responsive-accordion').each(function() {
			...
			// Hide panels
				...
				$('.responsive-accordion-panel:first', this).show();
				$('.responsive-accordion-head:first', this).addClass('active');
				$('.responsive-accordion-plus:first', this).hide();
				$('.responsive-accordion-minus:first', this).show();
